...
{
    [ApiVersion(2, 1)]
    public class SSControl : TerrariaPlugin
    {
        #region Plugin Info
        ...
        {
            get { return "Gives server administrators power over SSC whilst in-game."; }
        }
        public SSControl(Main game)
            : base(game)
        {
            Order = 4;
        }
        ...
        public List<NetItem> StarterItems = new();
        ...
        public override void Initialize()
        {
            ...
            {
                TShock.Log.ConsoleError("[SSControl]: SSC is not enabled! Please enable this if you want SSControl functionality.");
                this.Dispose();
            }
            else
            {
